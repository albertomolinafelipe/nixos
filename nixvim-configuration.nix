...

{
  programs.nixvim = {
    ...
    keymaps = [
      ...
      { mode = "n"; key = "<leader>E"; action = "<cmd>NvimTreeCollapse<CR>"; options.desc = "Collapse file tree"; }
      ...
      { mode = "n"; key = "<leader>x"; action.__raw = ''function() require("harpoon"):list():remove() end''; options.desc = "Harpoon remove current"; }
      ...
      lsp = {
        ...
        keymaps = {
          ...
          extra = [
            ...
            { key = "<leader>d"; mode = "n"; action = "<cmd>Lspsaga show_line_diagnostics<CR>"; options.desc = "Line diagnostics"; }
          ];
        };
      };
      lspsaga = {

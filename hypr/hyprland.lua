...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(e6c384ff)"} },
...
hl.config({
    -- Open new window in binary tree
    -- Open new window as master
    dwindle = {
        preserve_split = true,
    },
    master = {
...
hl.bind(mainMod .. " + SHIFT + ESCAPE", hl.dsp.exec_cmd("shutdown"))
...
-- Alt + Tab: jump back to the last workspace
hl.bind(mainMod .. " + TAB", hl.dsp.focus({ workspace = "previous" }))

-- Move focus with mainMod + hjkl (arrows kept too)
...
-- Move the window with mainMod + SHIFT + hjkl
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.window.move({ direction = "left" }))
hl.bind(mainMod .. " + SHIFT + J", hl.dsp.window.move({ direction = "down" }))
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.window.move({ direction = "up" }))
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.window.move({ direction = "right" }))

-- Resize the window with mainMod + CTRL + hjkl (hold to repeat)
